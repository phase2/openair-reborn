$(document).ready(function() {
  ...
  $rowTwo.append('<div class="p2_form-input_group p2_one-third"><label class="p2_form-label" for="p2_how_long">How Long?</label><input type="text" id="p2_how_long" name"p2_how_long" class="p2_input-field" /><div class="p2_form-submit_button"><input type="submit" value="Start" /></div></div>');
